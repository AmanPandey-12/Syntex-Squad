...
export const translations = {
  ...
  // ─── DETECTION PAGE ───
  'det.analyzingLeaf': {
    en: 'Analyzing leaf texture...', hi: 'पत्ती की बनावट की जांच...', te: 'ఆకు ఆకృతిని విశ్లేషిస్తోంది...', ta: 'இலை அமைப்பை ஆராய்கிறது...', bn: 'পাতার গঠন বিশ্লেষণ করা হচ্ছে...', mr: 'पानांच्या पोतचे विश्लेषण करत आहे...'
  },
  'det.comparingDatabase': {
    en: 'Comparing with database...', hi: 'डेटाबेस से तुलना...', te: 'డేటాబేస్‌తో పోల్చుతోంది...', ta: 'தரவுத்தளத்துடன் ஒப்பிடுகிறது...', bn: 'డేటాবেসের সাথে तुलना করা হচ্ছে...', mr: 'डेटाबेसशी तुलना करत आहे...'
  },
